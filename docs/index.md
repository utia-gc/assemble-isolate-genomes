...
Welcome to the [utia-gc/assemble-isolate-genomes](https://github.com/utia-gc/assemble-isolate-genomes) documentation!
...
In this case, please open a new issue in the [main repo issues page](https://github.com/utia-gc/assemble-isolate-genomes/issues) so that we can make sure the pipeline is useful to and usable by everyone.
